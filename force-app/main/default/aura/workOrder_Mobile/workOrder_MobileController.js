({
    ...
    handleTabClick: function (component, event, helper) {
        ...
        console.log("Selected the following nav item: " + event.currentTarget.name);
        let items = event.currentTarget.name;
        component.set("v.selectedItem", event.currentTarget.name);
        if (items == 'purchase') {
            component.set("v.activeItems", component.get("v.purchaseItems"));
        } else if (items == 'lease') {
            component.set("v.activeItems", component.get("v.leaseItems"));
        } else if (items == 'rental') {
            component.set("v.activeItems", component.get("v.rentalItems"));
        } else if (items == 'service') {
            component.set("v.activeItems", component.get("v.serviceItems"));
        } else {
            console.log("Unknown order nav item returned...");
        }
    },
